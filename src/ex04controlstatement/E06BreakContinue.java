...
/*
 * break: 반복문이나 switch문에서 주로 사용되며 블럭 내에서 탈출할 때 사용한다.
...
public class E06BreakContinue {
	...
	public static void main(String[] args) {
		...
		while(true) {
			/*
			 * 반복문 내에서 break, continue를 사용할 때에는 반드시 조건문과 같이 사용해야 한다.
			   그렇지 않으면 Unreachable Code 에러가 발생하여 해당 문장 하위는 실행되지 않는다.
			 */
			i++;
			System.out.printf("[i가 %d일때]\n", i);
			
			System.out.println("coninue 이전 출력문");
