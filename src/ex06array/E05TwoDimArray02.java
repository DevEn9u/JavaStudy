...
public class E05TwoDimArray02 {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 1) 세로2, 가로4의 2차원 배열을 선언한다.
		 2) 0에서 100사이의 난수를 이용하여 배열을 초기화한다.
		...
		/*
		 * 초기화 전, 후 두 번의 출력을 해야하므로 코드의 중복을 제거하기 위해
	...
	/*
	 * 매개변수로 전달된 정수만큼 2차원 배열의 전체 요소를 증가시킨다.
	 * 이를 위해 복합 대입 연산자를 사용하고 있다.
	 */
