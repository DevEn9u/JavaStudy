...
public class Ex02PreDefineException6 {
	...
	public static void main(String[] args)  {	
		...
		try {
			// 순수한 Object 인스턴스이므로 자식 타입으로 형변환할 수 없다.
	...
	/*
	 * String 인스턴스가 인수로 전달되면서 매개변수를 통해 Object로
	   자동형변환(업캐스팅)되므로 여기에서 상속관계가 확인된다. 매개변수 o는
	   원래 String 타입이었으므로 instanceof를 통해 String임을 
	   확인할 수 있고 이 경우에는 다운캐스팅이 가능하게 된다.
	 */
