...
public class QuValidateId {
	...
	public static void main(String[] args) {
		...
		System.out.print("8~12자 사이의 아이디를 입력하세요: ");
		String inputId = scanner.next();
		QuValidateId validator = new QuValidateId();
		boolean isValid = validator.idValidate(inputId);
		if(isValid) {
	...
	boolean idValidate(String inputId) {
