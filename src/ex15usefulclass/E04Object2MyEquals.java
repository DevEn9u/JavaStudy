...
public class E04Object2MyEquals {
	...
	public static void main(String[] args) {
		/*
		 * Stirng과 같은 기본클래스는 별도의 오버라이딩 없이도
		   내용비교가 가능하다.
		 */
		String str1 = new String("Java 개발자");
		String str2 = "Java 개발자";
		if(str1.equals(str2)) {
			System.out.println("같은 문자열입니다."); // 출력됨
		}
		else {
		...
		if(num1.myEquals(num2)) {
			...
			System.out.println("num1과 num2는 다른 정수");	// 출력됨	
		}
		
		/*
		 * 인스턴스간의 비교를 할때는 단순히 참조변수에 대한 비교를 하면
		   안되고, 실제 내용에 대한 비교를 해야 한다. 
		 */
		if(num1.myEquals(num3)) {
			System.out.println("num1과 num3은 동일한 정수"); // 출력됨
		}
		else {
