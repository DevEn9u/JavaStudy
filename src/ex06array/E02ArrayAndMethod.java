...
public class E02ArrayAndMethod {
	...
	public static void main(String[] args) {
		...
		// 초기화 된 배열
		int[] arr = {1, 2, 3, 4, 5};
		// 초기화되지 않은 배열, 배열 변수만 선언하고 참조할 인스턴스가 없는 상태
		int[] ref;
		...
		/*
		 * main에서 생생했던 배열 객체의 참조값을 매개변수로 넘기고,
		   다시 반환받았으므로 결국 동일한 배열을 참조하게 되어 아래 출력문에서는
		   동일한 결과가 2번 출력된다.
		 */
	...
	/*
	 * 매개변수로 전달된 배열의 참조값을 arr로 받게 되므로
	   해당 메서드에서도 동일한 배열을 참조할 수 있게 된다.
