	...
	public static void main(String[] args) {
		...
		/*
		 3] compareTo(): 2개의 문자열의 첫 번째 문자부터 순차적으로 비교하면서
		 	앞문자의 ASCII 코드가 크면 양수를 반환하고, 뒷 문자의 ASCII 코드가 크면
		...
		/*
		 4] concat(): 두 개의 문자열을 연결한다. print()문에서 '+'와 동일한 역할
		 */
		...
		/*
		 5] contains(): 문자열에 특정 문자열이 포함되었는지 판단한다.
			포함되었다면 true, 포함되지 않았다면 false를 반환한다.
		 */
