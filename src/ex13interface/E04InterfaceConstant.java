...
/*
 * 인터페이스에 변수를 정의하면 무조건 상수가 되므로 주로
   '인터페이스형 상수'라고 표현한다. 주로 프로그램에서의 설정값이나
   명시적인 코드를 위해 사용된다.
 */
...
public class E04InterfaceConstant {
	...
	public static void main(String[] args) {
		...
		System.out.println("숫자를 입력하여 무엇을 낼지 선택하세요.\n"
				+ "가위: 1, 바위: 2, 보: 3");
		...
		switch (sel) {
		/*
		 * 가위, 바위, 보를 각각 1, 2, 3으로 설정했지만 설정값이 많은 경우
