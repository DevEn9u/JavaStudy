...
public class E11Polymorphism {
	...
	public static void main(String[] args) {
		...
		// childMember는 자식쪽 멤버변수, 부모타입으로 자식인스턴스에 접근 불가
//		parent1.childMember = 1; // 에러 발생
		// 오버라이딩한 메서드이므로 자식쪽이 호출된다.
		...
		/*
		 * 부모의 참조변수로 접근하려면 아래와 같이 강제형변환(다운캐스팅)해야
		   한다. 소괄호를 이용해서 우선순위에 대한 부분을 처리해야 에러가 발생하지
		   않는다.
		 */
		// 
//		(MyChild)myParent.childMember = 1;
		 ...
		 * Object
		   ...
		   또한 Object 클래스에 정의된 모든 메서드를 별도의 처리 없이
