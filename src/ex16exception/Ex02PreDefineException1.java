...
public class Ex02PreDefineException1 {
	...
	public static void main(String[] args) {
		 ...
		 * 예외가 발생할 수 있는 지역을 try문으로 먼저 묶어준다.
		   예외가 발생하면 JVM은 해당 예외에 관련덴 인스턴스를 만들어서
		   프로그램쪽으로 전달(throw)한다. 이때 catch절에서 예외 인스턴스를
		   잡아주는 것을 '예외처리'라고 한다.
		...
		try {
			...
			/*
			 * 예외가 발생되는 지점. 해당 코드가 실행될때 에외가 발생하여
			   JVM이 예외 인스턴스를 만들어 프로그램으로 던진다.
			 */
			intArr[2] = 300;
			...
			// 예외메세지3: 예외에 대한 디테일한 설명을 출력한다. 가장 많이 사용된다.
			e.printStackTrace();
		}
