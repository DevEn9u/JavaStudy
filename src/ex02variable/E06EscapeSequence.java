...
//		System.out.println("나는 "개발자"가 되고싶어요");
		...
		/*
		 * 자리수 지정하기
		 * %4d: 정수 출력시 좌측으로부터 4칸 확보한 후 출력
		 * -4%d: 정수 출력시 우측으로부터 4칸 확보한 후 출력
		 * %6.2f: 실수 출력시 전체자리수는 6자리, 소수 이하 2자리로 표현
		 * 양수는 우측 정렬, 음수는 좌측 정렬 
		 */
