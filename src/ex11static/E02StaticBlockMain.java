...
/*
 * static블럭
 * 동일 클래스 내 main() 메서드보다 먼저 실행되는 블럭으로 main 메서드의 실행코드가 없어도
...
//		instanceMethod();
	...
	public static void main(String[] args) {
		...
		/*
		 * 위에서 정의한 static 블럭 내에서 선언된 변수는 지역 변수이므로
		   main 메서드에서는 사용할 수 없다. 해당 지역에서만 사용할 수 있다.
		 */
//		System.out.println("localVar="+ localVar); // 에러 발생
