...
//	public MyInterface1() {}
	 ...
	 */
	// public static final은 기본값이기 때문에 생략하는 것이 좋다.
	 ...
	 */
	// public abstract는 기본값이기 때문에 생략하는 것이 좋다.
...
/*
 * 인터페이스는 콤마(,)를 이용해서 여러개의 인터페이스를 '구현'할 수 있다.
...
class MyClass extends SimpleClass implements MyInterface1, MyInterface2 {
	 ...
	 * 인터페이스에 동일한 이름의 추상메서드가 존재하는 경우 하나만
	   오버라이딩하면 된다. 오버라이딩은 항상 자식쪽의 메서드가 호출되므로
	   아무런 문제도 발생하지 않는다.
	 */
	@Override
	...
	/*
	 * SimpleClass 클래스의 멤버메서드는 필요한 경우에만 오버라이딩 하면
	   된다. 필수사항이 아니므로 에러가 발생하지는 않는다.
	 */
}
...
public class E03InterfaceMain {
	...
	public static void main(String[] args) {
		 ...
		 * MyClass의 부모는 SImpleClass, MyInterface1, MyInterface2 셋 다 이다.
		 */
