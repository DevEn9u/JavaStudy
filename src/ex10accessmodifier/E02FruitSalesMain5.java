...
/////////////////////////////////////////////////
		 ...
		 * 아래 코드는 문법적으로는 오류가 없으나 지불금액과 구매한 사과의 관계가
		   ...
		   객체지향 프로그래밍에서는 이런 오류를 막기 위해
		   멤버변수에 대한 "정보은닉"을 권장하고 있다.
		   멤버변수의 외부 접근을 원천적으로 차단하고, 멤버메서드를 통해서만
		   접근하게 하여 논리적 오류를 차단하는 것이 목적이다.
		 */
		seller1.myMoney += 1000; // 판매자1에게 1000원을 지불
		buyer.myMoney -= 1000; // 지불로 인한 구매자의 보유 금액 차감
