 ...
 * switch 문에서는 조건문을 사용할 수 없고 산술식 혹은 정수식을 사용해야 한다.
 */
public class E02Switch {
	...
	public static void main(String[] args) {
		...
		/*
		 * Scanner 클래스: 사용자로부터의 입력값을 받기 위한 클래스
		   해당 클래스의 메서드가 실행되면 잠깐 실행이 중지되고 입력을 기다림.
		   보통 문자열이나 정수를 입력받기 위해 사용됨.
		 */
		Scanner scanner = new Scanner(System.in);
		System.out.println("숫자를 입력하세요");
		// nextInt() 메서드는 정수를 입력받기 위한 메서드이므로 문자를 입력하면
		// 예외(error)가 발생하면서 프로그램이 중지된다.
		...
		/*
		 * switch문 사용시 주의사항
		 * 1) long, double 타입 변수 사용 불가
		 * 2) byte, short, int, char, String만 사용할 수 있다.
		 * 3) 논리식, 조건식 사용 불가
		 */
		// long 타입 변수 사용불가
//		long ln = 100;
