...
/*
 * 부모클래스와 다른 패키지에 선언되었으므로 import 해야 한다.
   단, 부모클래스는 반드시 public으로 선언해야 한다.
   만약 default로 선언하면 동일 패키지에 속하지 않아 접근 자체가 불가능하므로 import 할 수 없다.
 */
...
//		super.privateMethod(); // 에러발생
		/*
		 * 이와 같이 직접 호출할 수 없는 메서드는 접근 가능한 멤버메서드를 통해
		   간접 호출한다.
		 */
	}
}
